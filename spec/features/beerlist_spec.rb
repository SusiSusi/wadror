...
describe "Beerlist page" do
  ...
  it "shows that beers are in alphabetical order", js:true do
    visit beerlist_path
  ...
  it "shows styles in alphabetical order when link is clicked", js:true do
    visit beerlist_path
    click_link('style')
  ...
  it "shows breweries in alphabetical order when link is clicked", js:true do
    visit beerlist_path
    click_link('brewery')
